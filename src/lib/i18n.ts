...
const translations = {
  en: {
    ...
    noItemsAssignedToMember: "No items assigned to {{name}}.",
    ...
    pastePlaceholder:
      "One item per line. Formats:\n• Tent\n• Sleeping bag x2\n• Headlamp #gear @25\n• Water bottle, 3, drinks, 12.5\n• Snacks\t2\tfood\t8",
    preview: "Preview",
    addFromPaste: "Add from paste",
    uploadSpreadsheet: "Upload Excel / CSV",
    uploadHint: "Header row: name, quantity (optional), category (optional), price (optional).",
    ...
    paymentsHint: "Log money you paid out of pocket (not tied to a specific item).",
    amountLabel: "Amount",
    amountPlaceholder: "0.00",
    paymentNote: "Note",
    paymentNotePlaceholder: "Optional note (e.g. gas, groceries)",
    addPayment: "Add payment",
    noPaymentsYet: "No payments logged yet.",
    deletePaymentConfirm: "Delete this payment entry?",
    viewSummary: "Summary",
    summaryTitle: "Settlement summary",
    totalTripCost: "Total trip cost",
    outstandingItems: "Outstanding (unclaimed items)",
    equalSplit: "Equal split per person",
    paidPerPerson: "Paid per person",
    ...
    personOwesPerson: "{{from}} owes {{to}} {{amount}}",
    ...
    errors: {
      ...
      couldNotUpdateItem:
        "You can only set the price on items you added or claimed.",
      couldNotEditItem: "You can only edit items you added.",
      itemNameRequired: "Item name cannot be empty.",
      couldNotUpdatePayment: "You can only edit your own payments.",
      couldNotDeletePayment: "You can only delete your own payments.",
  ...
  ar: {
    ...
    memberItems: "عناصر",
    memberPaying: "يدفع",
    memberPayments: "مدفوعات",
    memberCombinedTotal: "الإجمالي",
    ...
    noItemsAssignedToMember: "لا توجد عناصر محجوزة لـ {{name}}.",
    ...
    pasteList: "لصق قائمة",
    pastePlaceholder:
      "عنصر واحد في كل سطر. الصيغ:\n• خيمة\n• كيس نوم x2\n• مصباح #معدات @25\n• زجاجة ماء، 3، مشروبات، 12.5\n• وجبات\t2\tطعام\t8",
    preview: "معاينة",
    addFromPaste: "إضافة من اللصق",
    uploadSpreadsheet: "رفع Excel / CSV",
    uploadHint: "صف عناوين: name، quantity (اختياري)، category (اختياري)، price (اختياري).",
    ...
    paymentsHint: "سجّل المبالغ التي دفعتها من جيبك (غير مرتبطة بعنصر محدد).",
    amountLabel: "المبلغ",
    amountPlaceholder: "0.00",
    paymentNote: "ملاحظة",
    paymentNotePlaceholder: "ملاحظة اختيارية (مثل: بنزين، بقالة)",
    addPayment: "إضافة دفعة",
    noPaymentsYet: "لا توجد مدفوعات بعد.",
    deletePaymentConfirm: "حذف هذه الدفعة؟",
    viewSummary: "الملخص",
    summaryTitle: "ملخص التسوية",
    totalTripCost: "إجمالي تكلفة الرحلة",
    outstandingItems: "معلّق (عناصر غير محجوزة)",
    equalSplit: "الحصة المتساوية لكل شخص",
    paidPerPerson: "المدفوع لكل شخص",
    paidAmount: "دفع {{amount}}",
    isOwed: "يُستحق له {{amount}}",
    owesAmount: "يدين {{amount}}",
    settled: "مُسوّى",
    whoOwesWhom: "من يدين لمن",
    allSettled: "الجميع مُسوّون.",
    personOwesPerson: "{{from}} يدين لـ {{to}} {{amount}}",
    ...
    errors: {
      ...
      couldNotUpdateItem:
        "يمكنك تعيين السعر فقط للعناصر التي أضفتها أو حجزتها.",
      couldNotEditItem: "يمكنك تعديل العناصر التي أضفتها فقط.",
      itemNameRequired: "لا يمكن أن يكون اسم العنصر فارغاً.",
      couldNotUpdatePayment: "يمكنك تعديل مدفوعاتك فقط.",
      couldNotDeletePayment: "يمكنك حذف مدفوعاتك فقط.",
